...
class Pitre extends React.Component {
    render() {
        return (
<div>
<nav className="navbar is-transparent">
    ...
    <div>
    <CoolButton isSmall isDanger className="button is-rounded my-class is-danger is-small">Login</CoolButton>
    <CoolButton isSmall isSuccess className="button is-small is-success">Sign up</CoolButton>
    </div>
